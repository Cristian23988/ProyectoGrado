...
varPub = 10
numeroMIDI, frecHz, notaProxima, notaActual, distNotaProxima = 0, 0, 0, 0, 0
#elapsed_time = time
...
def PublicaNota():	
	...
	#Resultado
        global numeroMIDI, frecHz, notaProxima, notaActual, distNotaProxima
        numeroMIDI, frecHz, notaProxima, notaActual, distNotaProxima =  n, freq, note_name(n0), note_name(n0-1), (n-n0)
